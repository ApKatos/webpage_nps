<template>
  <div class="mainscreen">
    ...
    <div class="results-container">
      <div class="result" style="padding-right: 5vw">
        <div>
      ...
      <div class="result" style="padding-left: 5vw">
        ...
        <div class="text">
          ...
          >
            <div class="column" style="margin-right: 1.5em">
              ...
              <label
                :style="{ color: JSONresult.Alive ? 'greenyellow' : 'gray' }"
                :class="{
            ...
            <div class="column" style="margin-left: 1.5em">
              <label
                :style="{ color: JSONresult.Alive ? ' grey' : 'tomato' }"
                :class="{
                  'highlighted-label': !JSONresult.Alive,
                }"
              >
...
export default {
  ...
  data() {
    return {
      ...
      JSONresult: "",
      phenotypesdescribed:
        "Phenotypes represent the timed evolution of disease in range of 1-25. The closer to phenotype 25 the more developed disease",
      probdeathdescribed:
        "Out of all patiens from given phenotype group, this percentage of patients died at the end og their disease",
      patientgreyarea:
        " If the location of patient is the grey area then their evolution of disease can still be greatly influenced",
      aliveInfo:
        "This patient belongs to the phenotype group that will survive",
